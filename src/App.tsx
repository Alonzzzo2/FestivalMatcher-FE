            ...
            {entryMode === 'choose' ? (
              <div className="bg-gray-800 p-5 md:p-8 rounded-lg shadow-lg text-center">
                <div className="flex flex-col gap-6 md:gap-8">
                  <div>
                    <h3 className="text-lg md:text-xl font-bold text-blue-400 mb-3 md:mb-4 flex items-center justify-center gap-2">
                      <span>🎵</span> Festival Highlights
                    </h3>
                    <p className="text-gray-400 mb-4 md:mb-6 text-xs md:text-sm">Generate timeline highlights for a festival, from your music</p>
