...
export default function Footer({ onHeartClick }: FooterProps) {
  ...
  return (
    <footer className="bg-gray-800 border-t border-gray-700 py-3 mt-4">
      <div className="container mx-auto px-4 text-center text-gray-400 text-sm flex flex-col items-center gap-2">
        <p>
          Made with <span
            onClick={() => {
